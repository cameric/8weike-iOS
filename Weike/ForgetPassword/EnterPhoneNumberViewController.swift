...
final class ForgetPasswordPhoneViewController: WKUIViewController {
    // MARK: Properties

    fileprivate let enterPhoneNumberView = ForgetPasswordPhoneView()
...
extension ForgetPasswordPhoneViewController: ForgetPasswordPhoneViewDelegate {
    func nextButtonTapped() {
        if enterPhoneNumberView.formManager.checkForm() {
            // TODO: Send Request
            let enterPasscodeViewController = ForgetPasswordPasscodeViewController()
...
extension ForgetPasswordPhoneViewController: KeyboardDelegate {
